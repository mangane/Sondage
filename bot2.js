//NTIwMzIyNDA1OTgyNTM1NzA1.XVJVdw.UCIOlS7WOGNen3vc1T1hEAu5Nc0
...
client.on('ready',() => {
    let co = client.channels.find('id', "578224655077474335")
    let embed = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setDescription("Discord Créateur viens de redémarrer");
    co.send({embed})
})
client.on('ready', () => {
	setInterval(() => {
  ...
  //.addField ("Du salon :", "#" + message.channel.name)
    ...
    if (command === "gen") {
     ...
     message.channels.find(`id`, "583693815190126592").then(c => {
       message.channel.send(`http://discord.gg/${invite.code}`)
     })
...
message.channel.send({embed})
  ...
  .addField ("Du salon :", "#" + message.channel.name)
	...
	if(command === "invite") {
		...
		const embed = new Discord.RichEmbed()
		.setColor("RANDOM")
	.addField ("Rejoindre le support :","<a:premium:605934130353537062>[Rejoindre Le support](https://discord.gg/3TWatFe)")
    .addField ("Ajouter le bot :","<a:premium:605934130353537062> [Inviter le bot](https://discordapp.com/api/oauth2/authorize?client_id=520322405982535705&permissions=8&scope=bot)");
        message.channel.send({embed})
	}
  if (command === "count") {
...
name: "Les balises :",
value: "<a:erreur:606066052555866132>= commande indisponible\n <a:disponible:605932681527689236> = Commande disponible"
	  }], 
        footer: {
            ...
            base.edit({ embed: {
              color: 0xFF0000,
                fields: [{
                    ...
                    value: "**<a:erreur:606066052555866132>``g!mute``\ Réduit au silence la personne mentionné sur votre serveur, nécessite un rôle __Muted__\n<a:disponible:605932681527689236>``g!lock``\ Interdit au rôle everyone de parler sur le salon\n<a:disponible:605932681527689236>``g!unlock``\ Autorise de nouveaux au role everyone de parler\n<a:disponible:605932681527689236>``g!say``\ Fait parler le bot à votre place\n<a:disponible:605932681527689236>``g!slowmode``\ Mettre un slowmode (mettre 0 pour désactiver)\n<a:erreur:606066052555866132>``g!deleteserv``\ Détruit tout les salons de votre serveur (nous ne sommes pas responsable d'un mauvais usage de votre part)\n<a:disponible:605932681527689236>``g!eval``\ Réservé à l'owner du bot\n<a:disponible:605932681527689236>``g!kick``\ Exclut le membre mentionner\n<a:disponible:605932681527689236>``g!ban``\ Bannis le membre mentionner\n<a:disponible:605932681527689236>``g!reglement``vous fait un jolie règlement pré-definis**"
                }]
            }})
    ...
    if (reaction.emoji.name === "🔩") {
        ...
        base.edit({ embed : {
          color: 0xFF0000,
            fields: [{
                name: "Communautaire :",
                value: "<a:disponible:605932681527689236>``g!commu``\ **Crée votre serveur sous le thème de la communauté**"
            }, {
                name : "Basique :",
                value: "<a:disponible:605932681527689236>``g!salon``\ **Création de votre serveur sous le thème global**"
            }, {
                name : "Publicitaire :",
                value: "<a:disponible:605932681527689236>`g!pub``\ **Crée un serveur sous le thème Publicitaire**\n<:online:587292258282373130> ``g!p-2``\ **Crée un serveur sous le thème Publicitaire 2**"
            }, {
                name: "Uniquement les rôles",
                value: "<a:disponible:605932681527689236>``g!role``\ **Création des roles uniquement**"
            }, {
name: "Serveur Discord communauté Minecraft !",
value: "<a:disponible:605932681527689236>``g!mc``\ **Création d'un serveur sous le thème d'une communauté Minecraftienne**"
            }]
            }})
}
          if (reaction.emoji.name === "🔐") {
            ...
            base.edit ({ embed : {
              ...
              description: "<a:disponible:605932681527689236>``g!verif-on``\ **Vous permet D'activer une protection  (vérification à l'arrivée) sur votre serveur**\n <a:disponible:605932681527689236>``g!v-ok``\ **Permet de passez la vérification**\n ",
            }})
          }
          if(reaction.emoji.name === "⛔") {
          base.clearReactions();
...
if (command === "v-setup") {
  ...
  if(command === "mute") {
   ...
   var reason = msg;
      ...
      if(message.mentions.users.size === 0) return message.reply("La commande ne peux pas être éxecuté, vous avez oublié un argument (mentionner un utilisateur merci !) ")
      if (!reason || reason < 250 ) return message.channel.send("La commande ne peux pas être éxecuté, vous avez oublié un argument (Merci de mentionner la raison du mute")
  }
  
  }
});
client.login("NTU0Mjk1Njk1NTcwNjMyNzA0.XVUgNQ.IfFbP8wuKYP-GH-VZyOIoPf6hRE")
//NTIwMzIyNDA1OTgyNTM1NzA1.XVKh7Q.8pAPlAFGeNms0KdVcu5Iir5XAMk